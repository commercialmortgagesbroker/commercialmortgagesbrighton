/**
 * Service catalogue, Commercial Mortgages Brighton.
 *
...
Lender underwriting tests EBITDA cover (trading profit against the mortgage payment) at 1.3–1.5×, with two years of clean filed accounts the standard minimum. In Brighton the typical owner-occupier facility is £150K–£3M, with the bulk of volume in the £500K–£1.5M bracket. Loan-to-value of 70–75% is routine for established businesses; deposits of 25–30% from accumulated retained profit are standard. Interest rates currently 6.0–7.5% pa for strong covenants, stretching to 9.0% for tighter cases.
...
This is unregulated commercial lending in almost all cases, a business borrowing against business premises, not a residential mortgage. Owner-occupier commercial mortgages fall outside the Financial Conduct Authority's regulated mortgage perimeter; where a deal would require regulated permissions we refer to a regulated firm. Active sectors in Brighton: dental and GP practices (BN3 Hove and BN1 Preston Park clusters), accountancy and professional services, creative-led offices (Plus X at Preston Barracks, North Laine studios), pharmacy, and a substantial hospitality / hotel base on the seafront and in Kemptown. Sector-specialist trades, care home, MOT, nursery, route through trading-business mortgages.`,
    keyFeatures: [
...
Active Brighton investment areas: North Laine and The Lanes retail and upper-floor mixed-use, Kemptown and Hove semi-commercial parades, Preston Barracks creative offices, Edward Street Quarter and the Marina mixed-use cluster, plus limited industrial stock at Hollingbury and Patcham. Pricing currently 6.5–8.5% pa depending on covenant and LTV. Commercial investment lending is unregulated and sits outside the regulated mortgage perimeter in almost all cases.`,
    keyFeatures: [
    ...
    suitableFor: [
      "Investors buying let offices in Brighton city centre and Hove",
      "Landlords acquiring let retail (Churchill Square, North Laine, Western Road)",
      "Industrial investors (Hollingbury, Patcham, Sussex House)",
  ...
  },
  {
    ...
    fullDescription: `Semi-commercial is the term for finance against mixed-use property where the residential element is at least 40% of total floorspace, typically the classic shop-with-flat-above archetype that defines Brighton high streets. The product gives lenders comfort from the residential security, so semi-commercial routinely prices 50–100bps inside pure commercial investment.
...
Specialist lenders dominate this market. InterBay Commercial (OSB Group), Shawbrook, LendInvest, Together, Aldermore, YBS Commercial, HTB and Cambridge & Counties all run active programmes for Brighton semi-commercial deals between £150K and £2M. Stamp duty land tax follows non-residential rates on a genuinely mixed-use property, materially cheaper than residential SDLT.

Active Brighton semi-commercial spines: North Laine and The Lanes upper-floor mixed-use, Western Road and George Street in Hove, St James's Street in Kemptown, Seven Dials, London Road and Queens Park parades. Most semi-commercial lending is unregulated and sits outside the regulated mortgage perimeter, the exception is where the borrower personally occupies one of the residential flats, which falls into regulated territory and we refer to a regulated firm.`,
    keyFeatures: [
      ...
      "Interest rates from 7.5% pa",
      "5–25 year repayment terms",
      "Active across all Brighton and Hove high-street parades",
    ],
    typicalTerms: [
      { label: "LTV", value: "Up to 75%" },
      { label: "Rate", value: "From 7.5% pa" },
...
Aggregate ICR is tested across the portfolio at 140–150%. Tenant concentration matters, if more than 20–25% of income comes from a single tenant, lenders may price wider or cap loan-to-value. Most Brighton portfolio refinancing is taken out by a limited company holding structure (single corporate-level entity, or topco with subsidiary SPVs). Stamp duty land tax does not apply on a refinance (no transfer of ownership), which is part of why consolidation maths can work even when ERCs are in the model.

Shawbrook, Cambridge & Counties, InterBay Commercial and Cynergy Bank are the most active portfolio lenders for the £2M–£15M Brighton bracket. OakNorth and Reliance Bank cover larger. Portfolio refinancing is unregulated commercial lending and sits outside the regulated mortgage perimeter.`,
    keyFeatures: [
    ...
    suitableFor: [
      "Brighton-based commercial landlords with 5+ investment properties",
      "South Coast portfolio holders consolidating off multiple bank relationships",
...
Different lenders dominate different sub-sectors: Cynergy Bank and ASK Partners on pubs; Shawbrook, Cambridge & Counties and Hampshire Trust on care; Hampshire Trust and Allica on dental; Together on MOT/garage; Aldermore and Cambridge & Counties on nursery. Refinancing existing trading-business mortgages (typically off a maturing 5-year fix) is a frequent reason to re-engage. Trading-business commercial lending is unregulated and sits outside the regulated mortgage perimeter, not a residential mortgage.`,
    ...
    suitableFor: [
      "Pub and bar operators (North Laine, Kemptown, Hove)",
      "Hotel and B&B operators (Kings Road seafront, Kemptown, central Brighton)",
      "Care home operators (Hove, Withdean and Preston Park clusters)",
...
Most Brighton remortgaging is taken out by a limited company SPV or trading entity. Owner-occupier and investment commercial remortgaging both sit outside the regulated mortgage perimeter in standard cases, unregulated commercial lending throughout.`,
    keyFeatures: [
      "Whole-of-market benchmark across 90+ lenders",
...
LendInvest, Shawbrook, Together, OakNorth and Hampshire Trust Bank are the most active bridging desks for the Brighton £500K–£5M bracket. Bridge interest rates currently run 0.70–0.95% pm (8.5–11.5% pa equivalent); term-out pricing back to mainstream 6.5–8.5% pa once the property stabilises. Repayment is typically interest-only across the bridge period (serviced monthly or rolled-up) then full capital-and-interest on the term-out. Loan-to-value to 70% on current value; sometimes 75% on day-one purchase price plus 100% of refurb costs against GDV.
...
Where this works particularly well in Brighton: vacant BN1 / BN2 office floorplates being refurbished for re-letting; semi-commercial conversions on Western Road, North Laine and Kemptown parades; industrial units bought from receivers at Hollingbury; trading businesses (hotels, B&Bs, restaurants) bought as going concerns where the new operator needs 12 months of accounts before high-street remortgage. Commercial bridging on business property is unregulated and sits outside the regulated mortgage perimeter, where a deal would require regulated permissions, we refer to a regulated firm.`,
    keyFeatures: [
