...
export const faqItems: FAQItem[] = [
  ...
  {
    question: "How long does it take to arrange a Brighton commercial mortgage?",
  ...
  {
    question: "Which Brighton areas do you cover?",
    slug: "which-areas-do-you-cover",
    answer: `We arrange commercial mortgages across the full Brighton and Hove unitary area and the wider East Sussex footprint. Twelve area pages cover the active commercial sub-markets: Brighton City Centre, North Laine and The Lanes (BN1 prime retail, F&B, mixed-use upper-floor), Seafront and Kings Road (BN1/BN2 hospitality, hotel, leisure), Kemptown (BN2 F&B, semi-commercial, HMO), Hove Central and Western Road (BN3 high-street retail and professional services), Preston Park and Preston Barracks (BN1/BN2 creative innovation cluster, Plus X), Seven Dials (BN1 independent F&B, semi-commercial), London Road (BN1 high-street regeneration), Edward Street Quarter (BN2 major mixed-use regen), Brighton Marina (BN2 leisure, retail, hospitality), Hangleton and West Hove (BN3 suburban retail), Falmer and Lewes Road (BN1 university-adjacent HMO and PBSA-adjacent), Hollingbury and Patcham (BN1 outer industrial and trade). Beyond Brighton itself we routinely fund deals in Hove, Lewes, Newhaven, Worthing, Shoreham-by-Sea, Eastbourne and the wider South Coast commuter belt from the same Brighton-based lender panel.`,
    relatedLinks: [
