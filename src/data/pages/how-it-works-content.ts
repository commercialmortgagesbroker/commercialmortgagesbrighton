/**
 * /how-it-works page content, Commercial Mortgages Brighton.
 *
...
export const howItWorksContent: HowItWorksContent = {
  hero: {
    h1: "How a Brighton commercial mortgage actually completes",
    lede:
      "Five steps from initial enquiry to completion and drawdown. Indicative terms inside two business hours. RICS Red Book valuation in week two or three. Solicitor instruction in parallel. Funds drawn at completion in 4 to 8 weeks for clean owner-occupier and investment deals; 6 to 10 weeks where the sector underwrite needs more work, such as a Kings Road seafront hotel refinance or a Lewes Road HMO portfolio remortgage.",
  },

  intro: {
    h2: "Commercial mortgage in one paragraph",
    body: [
      'A commercial mortgage is <strong>long-term debt secured against income-producing or owner-occupied commercial property</strong>. In the Brighton market for mid-2026, facilities are typically structured at 65 to 75 percent LTV across 5 to 25 year terms, with monthly capital and interest payments. Rates run 6.0 to 9.0 percent pa depending on product, sector, LTV and covenant strength. Arrangement fees usually 1 to 2 percent of the facility, RICS Red Book valuation 1,500 to 8,000 pounds depending on asset complexity (Kings Road seafront hotel and listed-building work sits at the top of that band), and legal fees both sides.',
  ...
  criteria: {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "Gross rent against interest cost at 140 to 160 percent stressed at a notional rate 1 to 2 percent above the pay rate. Strong tenant covenant on a long lease prices best, creative-industries occupiers on full FRI leases at Preston Barracks and Plus X underwrite particularly cleanly.",
      },
      {
        label: "Deposit",
        detail:
  ...
  timeline: {
    h2: "How long does a Brighton commercial mortgage take?",
    body:
      'From a clean enquiry through to completion and drawdown: <strong>4 to 8 weeks</strong> for mainstream owner-occupier, commercial investment and semi-commercial. <strong>6 to 10 weeks</strong> for trading-business cases (Kings Road seafront hotel, Kemptown F&B, care home, Marina hospitality) and HMO portfolio refinance involving multi-property redemption sequencing across Lewes Road and Falmer. The critical-path item is almost always the RICS Red Book valuation. The fastest clean owner-occupier completion on our recent record was <strong>26 working days</strong>, a Kemptown F&B freehold purchase where the borrower had two years of clean accounts ready, the solicitor moved quickly on enquiries, and the lender had recent comparable approvals on file at the same South Coast valuer.',
  },
};
