/**
 * /services hub page content, Commercial Mortgages Brighton.
 *
 ...
 * NeuronWriter target ~652 words for the `commercial mortgage broker brighton`
...
export const servicesContent: ServicesContent = {
  hero: {
    h1: "Commercial Mortgage Broker Brighton, 90+ Lenders",
    lede:
  ...
  mapIntro: {
    h2: "Where the deals are placed across Brighton and East Sussex",
    body:
      'From the <a href="/areas/city-centre-north-laine-lanes" class="text-secondary font-medium hover:underline">BN1 city-centre core</a> retail and mixed-use market through the <a href="/areas/seafront-kings-road" class="text-secondary font-medium hover:underline">Kings Road seafront</a> hospitality strip, the <a href="/areas/kemptown" class="text-secondary font-medium hover:underline">Kemptown</a> and <a href="/areas/london-road" class="text-secondary font-medium hover:underline">London Road</a> semi-commercial parades, the <a href="/areas/preston-park-preston-barracks" class="text-secondary font-medium hover:underline">Preston Park and Preston Barracks</a> creative cluster, the <a href="/areas/edward-street-quarter" class="text-secondary font-medium hover:underline">Edward Street Quarter</a> regeneration scheme and the <a href="/areas/hollingbury-patcham" class="text-secondary font-medium hover:underline">Hollingbury</a> outer-ring industrial belt. Use the map below to see live placement activity across Brighton and Hove.',
  },
  ...
  services: [
    {
      ...
      paragraphs: [
        "When the business buys the building it trades from, the lending test is <strong>EBITDA cover</strong>, trading profit measured against the monthly mortgage payment, with a typical comfort threshold of 1.3–1.5×. This is the dental partnership taking the BN3 Hove surgery freehold off a retiring principal; the accountancy firm converting an Edward Street Quarter lease into a floor purchase; the engineering business buying its Hollingbury Industrial Estate trade-counter unit off the landlord. Two years of clean filed accounts is the standard minimum. LTV runs to <strong>75%</strong>, deposits of 25–30% are typically funded from accumulated retained profit (and occasionally capital-released equity from a director's home).",
        'Allica Bank, <strong>Shawbrook</strong>, HTB, Cambridge & Counties and <strong>Cynergy Bank</strong> sit at the sweet spot for owner-occupier lending. <strong>Lloyds</strong> commercial banking, <strong>NatWest</strong> North Street, <strong>Barclays</strong> North Street and <strong>Santander</strong> price competitively where the covenant is strong and the sector is mainstream. Mid-2026 interest rates: <strong>6.0–7.5% pa</strong>. Term length is the lever that materially changes affordability, extending repayment from 15 to 20 years frequently clears the EBITDA test where rate alone will not. Owner-occupier sits outside FCA regulation in most cases (it is a business borrowing for business premises, not a residential mortgage).',
        'Sectors with the deepest lender appetite in Brighton: dental and GP practices (the BN3 Hove and BN1 Preston Park clusters are recognised sub-markets), accountancy, legal and other professional services, creative-led offices (Plus X at Preston Barracks, North Laine studios), light industrial and trade-counter (Hollingbury, Patcham, Sussex House) and pharmacy. Sector-specialist trades, care home, MOT, day nursery, route through <a href="/services/trading-business-mortgage" class="text-secondary font-medium hover:underline">trading-business mortgages</a> instead.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Tenant covenant and lease length carry as much weight as LTV. A 10-year unbroken FRI lease to a national covenant on an Edward Street Quarter Grade A office prices materially better than three two-year leases to local independents on a secondary parade. <strong>NatWest</strong>, <strong>Lloyds</strong>, <strong>Barclays</strong> and <strong>Santander</strong> compete hard on prime single-asset investment; <strong>Shawbrook</strong>, <strong>InterBay Commercial</strong>, <strong>LendInvest</strong> and Together cover the trickier end (multi-let, short-WAULT, semi-commercial, vacant-with-refurb). Interest rates currently <strong>6.5–8.5% pa</strong>.',
        'Active areas: <a href="/areas/city-centre-north-laine-lanes" class="text-secondary font-medium hover:underline">city-centre retail and mixed-use</a>, <a href="/areas/kemptown" class="text-secondary font-medium hover:underline">Kemptown</a> semi-commercial parades, <a href="/areas/preston-park-preston-barracks" class="text-secondary font-medium hover:underline">Plus X at Preston Barracks</a> creative offices, and the Hollingbury and Patcham outer-ring industrial belt.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        'Semi-commercial finance funds mixed-use property where the residential element is at least 40% of total floorspace, the classic shop-with-flat-above archetype that defines Brighton high streets like North Laine and The Lanes in BN1, St James\'s Street in <a href="/areas/kemptown" class="text-secondary font-medium hover:underline">Kemptown</a>, the <a href="/areas/london-road" class="text-secondary font-medium hover:underline">London Road</a> regen corridor, Western Road and George Street in <a href="/areas/hove-central" class="text-secondary font-medium hover:underline">Hove Central</a>, and the parades around <a href="/areas/seven-dials" class="text-secondary font-medium hover:underline">Seven Dials</a>. The flat above gives lenders residential security comfort, so semi-commercial routinely prices 50–100bps inside pure commercial investment.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '<strong>Shawbrook</strong>, Cambridge & Counties, <strong>InterBay Commercial</strong> and <strong>Cynergy Bank</strong> are the most active portfolio lenders for the £2M–£15M Brighton bracket. OakNorth and Reliance Bank cover larger facility sizes. Aggregate ICR is tested across the portfolio at <strong>140–150%</strong>; tenant concentration matters (more than 20–25% of income from one tenant tightens pricing); sector concentration matters; East Sussex and South Coast geographic concentration is fine.',
    ...
    },
    {
      ...
      paragraphs: [
        'Trading-business mortgages fund operational property where value is bound up with the business that runs from it. Pubs and bars in North Laine, Kemptown and Hove; seafront hotels on Kings Road and Marine Parade; care homes in Withdean, Hove and the wider Preston Park catchment; MOT and garages along Sackville Road, Old Shoreham Road and at Patcham Court Farm; day nurseries across the BN1 Preston Park and BN3 Hove catchments; dental practices around BN3 Hove and Eastern Road (BN2); B&Bs along the BN1 and BN2 seafront and in Kemptown.',
        'Underwriting is sector-specific. <strong>Pubs</strong>: barrelage, EBITDA, beer-tie status, license, <strong>Cynergy Bank</strong> and ASK Partners dominate. <strong>Hotels</strong>: occupancy, ADR, RevPAR. <strong>Care homes</strong>: CQC rating, occupancy, weighted-average bed value, council/private fee mix, <strong>Shawbrook</strong>, Cambridge & Counties and Hampshire Trust hold significant South Coast books. <strong>Dental</strong>: NHS UDA value plus private fee mix. <strong>MOT</strong>: VOSA approval, environmental due diligence. <strong>Nursery</strong>: Ofsted rating, registered places, occupancy.',
    ...
    },
    {
      ...
      paragraphs: [
        'Commercial remortgage covers two distinct moments. End of a typical 5-year fix maturing into a different rate environment; or capital-raise refinancing that releases equity from a property that has appreciated since the original draw. With Bank of England base-rate trajectory through 2026 looking flatter than the 2023–24 cycle, refinancing demand into Brighton is strong, particularly on assets bought 2019–2021 where current valuations support a meaningfully better LTV than the original facility.',
        ...
        'For end-of-fix the underwriting story is usually clean, known asset, known borrower, known track record. <strong>NatWest</strong>, <strong>Lloyds</strong>, <strong>Barclays</strong>, <strong>Santander</strong>, <strong>Shawbrook</strong>, Allica, HTB, Cambridge & Counties and <strong>InterBay Commercial</strong> all compete on clean Brighton remortgage business. Pricing for owner-occupier remortgage at 65% LTV on a strong covenant: <strong>6.0–7.5% pa</strong>. Investment remortgage 6.5–8.5% pa.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '<strong>LendInvest</strong>, <strong>Shawbrook</strong>, Together, OakNorth and Hampshire Trust Bank are the most active commercial bridging desks for the Brighton £500K–£5M bracket. Bridge interest rates currently run <strong>0.70–0.95% pm</strong> (8.5–11.5% pa equivalent); term-out pricing back to mainstream <strong>6.5–8.5% pa</strong> once the property stabilises and the ICR test passes. Interest can be serviced monthly or rolled-up; LTVs to 70% on current value, sometimes 75% on day-one purchase price plus 100% of refurb costs against GDV.',
        'Where this works particularly well in Brighton: vacant BN1 / BN2 office floorplates being refurbished for re-letting; semi-commercial conversions on Western Road, North Laine and Kemptown parades (shop+flat-above stock being upgraded); industrial units bought from receivers at Hollingbury; trading businesses (hotels, B&Bs, restaurants) bought as going concerns where the new operator needs 12 months of accounts before a high-street remortgage will engage.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '<strong>InterBay Commercial</strong>, Together, United Trust Bank and select private-credit desks are the active second-charge commercial lenders for Brighton. Pricing reflects subordinated risk: <strong>10–14% pa</strong> typically, arrangement fees of 2–3%. Combined LTV (first plus second) usually capped at <strong>70–75%</strong>, occasionally flexed to 80% on strong investment cases.',
  ...
  networkBand: {
    ...
    paragraphs: [
      ...
      "Owner-occupier in Manchester, portfolio refinancing across East Sussex and the South Coast, a trading-business mortgage in Newcastle, or a commercial remortgage on a Bristol office, the same panel, the same diagnostic process, the same unregulated commercial product set.",
    ],
  },

  finalCta: {
    h2: "Which product fits your Brighton deal?",
    body:
