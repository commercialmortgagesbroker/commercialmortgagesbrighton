...
export const metadata: Metadata = {
  title: {
    default: `Commercial Mortgages Brighton | Specialist Brighton Commercial Mortgage Broker`,
    template: `%s | ${brand}`,
  },
  description:
    "Commercial mortgages in Brighton from a specialist commercial mortgage broker. Hotel and hospitality, owner-occupier, commercial investment, semi-commercial, HMO portfolio refinance and trading-business commercial mortgages placed across a 90-plus lender panel. Indicative terms in 48 hours, mid-2026 Brighton commercial mortgage rates 6.0 to 9.0% pa.",
  keywords: [
    kw,
    ...
    `${loc} hospitality finance`,
    `${loc} hmo portfolio refinance`,
  ],
  ...
  openGraph: {
    ...
    siteName: brand,
    title: `Commercial Mortgages Brighton | Specialist Brighton Commercial Mortgage Broker`,
    description:
      "Commercial mortgages in Brighton from a specialist commercial mortgage broker. Hotel and hospitality, owner-occupier, commercial investment, semi-commercial, HMO portfolio refinance and trading-business commercial mortgages placed across a 90-plus lender panel. Indicative terms in 48 hours, mid-2026 Brighton commercial mortgage rates 6.0 to 9.0% pa.",
  },
  twitter: {
