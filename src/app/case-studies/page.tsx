...
export const metadata: Metadata = {
  title: `${loc} Commercial Mortgage Case Studies | Hospitality, Owner-Occupier, Investment, HMO Portfolio`,
  description: `Real ${loc} commercial mortgage case studies, hospitality, owner-occupier, investment, semi-commercial, trading-business and portfolio refinance deals across Kings Road seafront, Lewes Road HMO, Hove professional services, Edward Street Quarter, Kemptown, North Laine, Brighton Marina, Preston Barracks, Western Road and Falmer.`,
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-xl leading-relaxed text-gray-300">
              Representative {loc} and Hove commercial mortgages we&apos;ve
              placed recently across seafront hospitality, owner-occupier
              freehold, creative-office investment, HMO portfolio refinance,
              semi-commercial and trading-business. Product type, lender,
              pricing and the reason the file landed where it did.
            </p>
          </div>
        </div>
      </section>
